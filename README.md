...
*The registration information will be verified by the technicians of ROSE Lab. Generally, the verification will be completed in one working day. Note that the verfication may be delayed if the registration information is incompleted (e.g., incomplete institute name) or non-institutional email is provided (e.g., using gmail).*
